          ...
          <div className="contact4-content6">
            ...
            <div className="contact4-contact-info3">
              <div className="contact4-content7">
                ...
                <p className="contact4-text9 thq-body-large">
                  {props.content5}
                </p>
              </div>
...
Contact4.defaultProps = {
  content4: 'Check out my latest posts and projects on social media.',
  phone1: '+1 (555) 000-0000',
  email1: 'hello@teleporthq.io',
  content2:
    "I'm open to freelance work, consultation, and entrepreneurship ideas/projects.",
  content3:
    "Let's connect on Twitter and LinkedIn for more updates and discussions.",
  content5:
    'If you enjoy my content and would like to support me, consider buying me a coffee. Thank you!',
