      ...
      <div className="contact3-max-width thq-section-max-width">
        <div className="contact3-section-title">
          ...
          <div className="contact3-content1">
            ...
            <p className="contact3-text3 thq-body-large">{props.content1}</p>
          </div>
        </div>
          ...
          <div className="contact3-content2">
            ...
            <div className="contact3-contact-info1">
              <div className="contact3-content3">
                <h3 className="contact3-text4 thq-heading-3">Email</h3>
                <p className="contact3-text5 thq-body-large">
                  {props.content3}
                </p>
              </div>
          ...
          <div className="contact3-content4">
            ...
            <div className="contact3-contact-info2">
              <div className="contact3-content5">
                <h3 className="contact3-text6 thq-heading-3">Phone</h3>
                <p className="contact3-text7 thq-body-large">
                  {props.content4}
                </p>
              </div>
          ...
          <div className="contact3-content6">
            ...
            <div className="contact3-contact-info3">
              <div className="contact3-content7">
                <h3 className="contact3-text8 thq-heading-3">Office</h3>
                <p className="contact3-text9 thq-body-large">
                  {props.content5}
                </p>
              </div>
...
Contact3.defaultProps = {
  content1:
    'Feel free to reach out to me for collaborations, freelance opportunities, or just to say hello!',
